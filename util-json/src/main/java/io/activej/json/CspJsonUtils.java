...
public final class CspJsonUtils {
	public static <I, O> ByteBufsCodec<I, O> nullTerminatedJson(Class<? extends I> inClass, Class<? super O> outClass) {
		return ByteBufsCodec
				...
				.andThen(
						buf -> fromJson(inClass, buf.asString(UTF_8)),
						item -> toJsonBuf(outClass, item));
	}
