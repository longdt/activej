...
public final class Promises {
	...
	@NotNull
	@SafeVarargs
	public static <T> Promise<T> any(@NotNull BiPredicate<T, Throwable> predicate, Promise<? extends T>... promises) {
	...
	@NotNull
	@SafeVarargs
	public static Promise<Void> sequence(AsyncSupplier<Void>... promises) {
