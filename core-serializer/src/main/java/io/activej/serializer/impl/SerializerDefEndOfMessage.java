...
public final class SerializerDefEndOfMessage extends AbstractSerializerDef {
	protected final SerializerDef serializer;

	public SerializerDefEndOfMessage(SerializerDef serializer) {
	...
	public Expression decoder(StaticDecoders staticDecoders, Expression in, int version, CompatibilityLevel compatibilityLevel) {
		return let(serializer.defineDecoder(staticDecoders, in, version, compatibilityLevel),
				result -> ifThenElse(cmpEq(readByte(in), value((byte) 1)),
						result,
